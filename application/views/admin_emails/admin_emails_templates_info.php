...
<?php foreach ($ticket_end_user_templates->result() as $ticket_end_user) { ?>
    <strong><a href="<?php echo site_url('admin_emails_controller/emails_templates_edit')?>?code_name=<?php echo $ticket_end_user->email_tpl_guid?>"><?php echo $ticket_end_user->title;?></a></strong><br>
...
<?php foreach ($ticket_agent_templates->result() as $ticket_agent) { ?>
    <strong><a href="<?php echo site_url('admin_emails_controller/emails_templates_edit')?>?code_name=<?php echo $ticket_agent->email_tpl_guid?>"><?php echo $ticket_agent->title;?></a></strong><br>
...
<?php foreach ($task_templates->result() as $task) { ?>
    <strong><a href="<?php echo site_url('admin_emails_controller/emails_templates_edit')?>?code_name=<?php echo $task->email_tpl_guid?>"><?php echo $task->title;?></a></strong><br>
