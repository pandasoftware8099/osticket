<div id="content">
        <form class="form-horizontal" action="<?php echo site_url('admin_manage_controller/manage_subtopics_info_process')?>?id=<?php echo $_REQUEST['id']?>" method="post">
    <h2>Update Sub Topics            <small>
    — <?php echo $subtopic->value;?></small></h2>
    <div class="tab">
...
<div id="definition" class="tab_content ">
    ...
    <div class="form-group" style="overflow:auto;">
        ...
        <div class="col-lg-10">
            <input size="50" class="form-control" type="text" name="name" data-translate-tag="" autofocus="" value="<?php echo $subtopic->value ?>"> <span class="error"></span>        </div>
    </div>
    <div class="form-group" style="overflow:auto;">
        ...
        <div class="col-lg-9">
            <select required="true" id="type" name="topicId" class="form-control">
              ...
              <option <?php echo ($subtopic->topic_guid == $reason->topic_guid)?"selected":""; ?> value="<?php echo $reason->topic_guid?>"><?php echo $reason->topic?></option>
              <?php }?>
            </select></div>
    </div>
    ...
    <div class="box">
            ...
            <div class="box-body pad">
                ...
                <textarea name="notes" class="textarea" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $subtopic->notes ?></textarea>
