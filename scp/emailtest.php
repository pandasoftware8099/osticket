...
?>
<form class="form-horizontal" action="emailtest.php" method="post" class="save">
 <?php csrf_token(); ?>
 <input type="hidden" name="do" value="<?php echo $action; ?>">
 <h2><?php echo __('Test Outgoing Email');?></h2>
 <div class="section-break" style="margin-bottom:10px;">
    <em><i class="help-tip icon-question-sign" href="#test_outgoing_email"></i> <?php echo __('Use the following form to test whether your <strong>Outgoing Email</strong> settings are properly established.');
                    ?></em>
</div>
<div class="form-group">
    <label class="col-lg-2 control-label"><span class="error">*</span><?php echo __('From');?> :</label>
    <div class="col-lg-10">
...
<div class="form-group">
    <label class="col-lg-2 control-label"><span class="error">*&nbsp;</span><?php echo __('To');?> :</label>
    <div class="col-lg-10">
        <input type="text" size="60" class="form-control" name="email" value="<?php echo $info['email']; ?>"
                autofocus>
            &nbsp;<span class="error"><?php echo $errors['email']; ?></span>
    </div>
</div>
<div class="form-group">
    <label class="col-lg-2 control-label"><span class="error">*&nbsp;</span><?php echo __('Subject');?> :</label>
    <div class="col-lg-10">
        <input type="text" size="60" class="form-control" name="subj" value="<?php echo $info['subj']; ?>">
