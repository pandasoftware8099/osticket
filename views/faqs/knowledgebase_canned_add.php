<div id="content">
        <form id="mass-actions" action="<?php echo site_url('staff_faqs_controller/canned_response_add_process')?>" method="POST" name="staff" enctype="multipart/form-data">
...
<div class="form-group" style="overflow:auto;">
    ...
    <div class="col-lg-9">
        <label><input type="radio" name="isenabled" value="1" checked="checked">&nbsp;Active&nbsp;</label>
        <label><input type="radio" name="isenabled" value="0">&nbsp;Disabled&nbsp;</label>
...
<div class="form-group" style="overflow:auto;">
    ...
    <div class="col-lg-9">
        <input type="text" size="70" class="form-control" name="title" value="">
        <span class="error"></span>
    </div>
</div>
<div class="form-group" style="overflow:auto;">
    ...
    <div class="col-lg-12">
        <textarea required="true" name="canned_response" id="ticket-response" class="textarea" placeholder="Start writing your message here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
    </div>
</div>
<!-- <div>
...
<div class="col-lg-12">
    <textarea required="true" name="notes" id="ticket-response" class="textarea" placeholder="Start writing your message here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
</div>
