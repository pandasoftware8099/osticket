<div id="content">
        <form class="form-horizontal" action="<?php echo site_url('admin_agents_controller/agents_departments_info_process');?>?id=<?php echo $_REQUEST['id']?>" method="post">

<h2>Update Department    <small>
    — <?php echo $departmentinfo->name ?></small>
    </h2>
<div class="tab">
    <ul class="clean tabs">
        <li class="active"><a href="#settings">
            <i class="icon-file"></i> Settings</a></li>
        <li class=""><a href="#access">
          <i class="icon-user"></i> Access</a></li>
    </ul>
</div>
<div id="settings" class="tab_content" style="display: block;">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <select name="pid" class="form-control">
                ...
                <?php if ($value['depart_id'] != $_REQUEST['id']) { ?>
                <option value="<?php echo $value['depart_id']?>" <?php echo ($value['depart_id'] == $departmentinfo->pid )?"selected":""; ?> ><?php echo $value['depart_name']?></option>
                <?php } ?>
                <?php } ?>
            </select>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <input required="true" class="form-control" data-translate-tag="94303f0a957e03ca" type="text" size="30" name="name" value="<?php echo $departmentinfo->name ?>" autofocus="">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <label>
            <input type="radio" name="ispublic" value="1"  <?php echo ($departmentinfo->ispublic == 1)?"checked":""; ?>><strong>Public</strong>
            </label>
            &nbsp;
            <label>
            <input type="radio" name="ispublic" value="0"  <?php echo ($departmentinfo->ispublic == 0)?"checked":""; ?>><strong>Private</strong> (Internal)            </label>
        </div>
    </div>
    <div class="form-group">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-lg-10">
            <label>
                <input type="checkbox" name="assign_members_only" <?php echo ($departmentinfo->flags == 1 || $departmentinfo->flags == 3 )?"checked":""; ?>>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <label>
                <input type="checkbox" name="disable_auto_claim" <?php echo ($departmentinfo->flags == 2 || $departmentinfo->flags == 3 )?"checked":""; ?> >
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <label>
                <input type="checkbox" name="ticket_auto_response" value="0" <?php echo ($departmentinfo->ticket_auto_response == 0 )?"checked":""; ?>>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <label>
                <input type="checkbox" name="message_auto_response" value="0" <?php echo ($departmentinfo->message_auto_response == 0 )?"checked":""; ?>>
                <strong>Disable</strong> for this department            </label>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <select name="group_membership" class="form-control">
              <option <?php echo (2 == $departmentinfo->group_membership )?"selected":""; ?> value="2">No one (disable Alerts and Notices)</option>                    
              <option <?php echo (0 == $departmentinfo->group_membership )?"selected":""; ?> value="0">Department members only</option>                    
              <option <?php echo (1 == $departmentinfo->group_membership )?"selected":""; ?> value="1">Department and extended access members</option>            </select>
        </div>
    </div> -->
    <div class="section-break" style="margin-bottom:10px;">
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body pad">
                ...
                <textarea name="deptsignature" class="textarea" placeholder="Place some text here"style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $departmentinfo->signature?></textarea>
...
<div id="access" class="hiddens tab_content" style="display: none;">
...
var addAccessprimary = function(staffid, name, role, alerts, primary, error) {
  ...
  if (primary) {
    ...
    copy.find('[data-name^=member_alerts]')
      ...
      .prop('checked', primary || alerts);
    copy.find('[data-name^=member_role]')
      .attr('name', 'primary_role[]')
      .val(role || 0);
    copy.find('[data-name=members\\[\\]]')
      .attr('name', 'primary_members[]')
      .val(staffid);
...
$('#add_extended_access_1').find('button').on('click', function(){
    ...
    $.ajax({
        url: "<?php echo site_url('insertdepartment_c/main');?>?id=<?php echo $_REQUEST['id'] ?>&id1=" + selected.val(),
        dataType: "json",
