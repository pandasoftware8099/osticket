<div id="content">
        ...
        <form action="<?php echo site_url('admin_agents_controller/agents_teams_process')?>" method="POST" name="teams">
<div class="sticky placeholder"></div><div class="sticky bar">
    <div class="content" style="width: 908px;">
        <div class="pull-left">
            <h2><i class="help-tip icon-question-sign notsticky" href="#teams"></i> Teams            </h2>
        </div>
        <div class="pull-right flush-right">
            <a href="<?php echo site_url('admin_agents_controller/agents_teams_add')?>" class="green button action-button"><i class="icon-plus-sign"></i> Add New Team</a>
...
<table id="ttable" class="list" border="0" cellspacing="1" cellpadding="0" width="100%" style="    white-space: nowrap;">
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="36%">Team Name</th>
            <th style="padding-left:4px;vertical-align:middle" width="8%">Status</th>
            
            <th style="padding-left:4px;vertical-align:middle" width="14%">Member</th>
            <th style="padding-left:4px;vertical-align:middle" width="20%" nowrap="">Team Lead</th>
