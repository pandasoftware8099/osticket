...
<div id="overlay"></div>
<div id="loading" style="top: 119px; left: 524.5px;">
    <i class="icon-spinner icon-spin icon-3x pull-left icon-light"></i>
    <h1>Loading ...</h1>
</div>
<div class="container dialog draggable ui-draggable" style="display: none; top: 29.75px; left: 374.5px;" id="popup">
...
<div style="display: none; top: 29.75px; left: 618.5px;" class="dialog" id="alert">
