...
<div class="sticky placeholder"></div><div class="sticky bar">
    <div class="content" style="width: 908px;">
        <div class="pull-left">
            <h2></i> Banned Email Addresses
            </h2>
        </div>
        <div class="pull-right flush-right">
            <a href="<?php echo site_url('admin_emails_controller/emails_banlist_add')?>" class="green button action-button"><i class="icon-plus-sign"></i> Ban New Email</a>
...
<table id="ttable" class="list" border="0" cellspacing="1" cellpadding="0" width="100%" style="white-space: nowrap;">
        <thead>
            ...
            <th style="padding-left:4px;vertical-align:middle" width="8%">Ban Status</th>
