<div id="content">
        ...
        <form action="<?php echo site_url('admin_emails_controller/emails_banlist_process')?>" method="POST" name="roles">
<div class="sticky placeholder"></div><div class="sticky bar">
    <div class="content" style="width: 908px;">
        ...
        <div class="pull-right flush-right">
            <a href="<?php echo site_url('admin_emails_controller/emails_banlist_add')?>" class="green button action-button"><i class="icon-plus-sign"></i> Add New Template Set</a>
...
<table id="ttable" class="list" border="0" cellspacing="1" cellpadding="0" width="100%" style="white-space: nowrap;">
        ...
        <tbody><?php foreach ($templategroup->result() as $value) { ?>
                    <tr>
                    <td align="center">
                      <input type="checkbox" class="ckb" id="tids" name="tids[]" value="<?php echo $value->tpl_id?>">
                    </td>
                    <td>&nbsp;<a href="<?php echo site_url('admin_emails_controller/emails_template_info')?>?id=<?php echo $value->tpl_id?>"><?php echo $value->name?></a></td>
                    <td><?php if ($value->isactive == 1){ ?>
                      ...
                      <?php } ?></td>
                    <td>Need to find where is it in database</td>
